...
def draw_window(win, birds, pipes, base, score, gen, popu, pipe_ind):
    win.blit(BG_IMG, (0, 0))
    ...
    text = STAT_FONT.render("pop: " + str(popu), 1, (255, 255, 255))
    win.blit(text, (10, 35))
...
def eval_genomes(genomes, config):
    ...
    while run:
        ...
        if add_pipe:
            ...
            pipes.append(Pipe(600))  # this is the gap between the pipes
        ...
        draw_window(win, birds, pipes, base, score, GEN, pop, pipe_ind)
